...
echo -e "${BIYellow}□ AutoScript By Dev   = Wak ${GREEN}( NevermoreSSH )${NC}"

echo -e "${BICyan} ┌─────────────────────────────────────────────────────┐${NC}"
echo -e "${BICyan} │         ${BIWhite}${UWhite}NevermoreSSH TUNNELING${NC}     ${BICyan}│${NC}"
echo -e "${BICyan} │                                                     │${NC}"
echo -e " ${BICyan}│  ${BICyan}Use Core        :  ${BIPurple}XRAY${NC}      ${BICyan}│${NC}"
echo -e " ${BICyan}│  ${BICyan}IP-VPS          :  ${BIYellow}$IPVPS   ${BICyan}│${NC}"
echo -e " ${BICyan}└─────────────────────────────────────────────────────┘${NC}"

echo -e "${GREEN}Just a little patience${NC}" 
...
13) clear ; slow ;;
99) clear ; clearcache ;;
6969) clear ; wget https://raw.githubusercontent.com/NevermoreSSH/vpn2/main/update.sh && chmod +x update.sh && ./update.sh && rm -f /root/update.sh ;;
0) clear ; menu ;;
x) exit ;;
