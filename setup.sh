...
echo ""
wget -q https://raw.githubusercontent.com/NevermoreSSH/v4/main/tools.sh;chmod +x tools.sh;./tools.sh
rm tools.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/NevermoreSSH/vpn2/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
...
sleep 2
clear
wget https://raw.githubusercontent.com/NevermoreSSH/v4/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/NevermoreSSH/vpn2/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
